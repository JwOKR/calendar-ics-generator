...
function generateIndex() {
  // 使用当前配置重新生成 index.html
  const repoOwner = process.env.GITHUB_REPOSITORY_OWNER || 'unknown';
  const repoName = process.env.GITHUB_REPOSITORY_NAME || 'calendar-ics-generator';
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>🤖 由 GitHub Actions 自动生成 | 每天北京时间凌晨2点自动更新</p>
            <p style="margin-top:8px;">💡 点击订阅链接可复制 | <a href="https://github.com/${repoFullName}" target="_blank">GitHub 仓库</a></p>
        </div>
    </div>
